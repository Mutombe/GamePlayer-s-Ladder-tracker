/*
 * Declarations and definitions for functions which manipulate player records which form the basis of the ladder
 *
 */
...
#define CHALLENGE_RANGE	/* number of higher ranked players who may be challenged to move up in rank */
...
/*
 * Declarations for routines used to manipulate the player records and ladder file which are defined in player.c
 *
 */
